...
function CompactSticker({ player, ratingBoost, duplicateCount }: { player: Player; ratingBoost: number; duplicateCount: number }) {
  ...
  if (cupTheme) {
    return (
      <div className={`compact-sticker sticker-cup-legend flex aspect-[3/4] min-h-32 flex-col rounded-md border-2 ${cupTheme.border} bg-gradient-to-br ${cupTheme.colours} p-2 text-slate-950 shadow-sm ring-1 ring-green-950/10`}>
        <div className="mb-1 flex items-center justify-between gap-1">
          <span className="rounded bg-white/65 px-1 text-[9px] font-black uppercase">{player.pos}</span>
        ...
        <div className="mt-1 flex items-center justify-between border-t border-slate-950/20 pt-1 text-[8px] font-black uppercase tracking-wide opacity-80">
          <span>Cup Legend</span>
